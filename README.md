...
### 🚫 GUI Frustrations (Gnome-Boxes, virt-manager)

- ❌ **Slow over SSH** (requires X11 forwarding)
- ❌ **Mouse-dependent** (constant clicking)
- ❌ **Heavy resource usage** (400MB+ RAM)
- ❌ **Not scriptable** (manual work only)
- ❌ **Context switching** (Alt+Tab hell)
- ❌ **Desktop required** (no headless support)
- ❌ **Single-system** (one GUI per machine)

</td>
<td width="50%" valign="top">

### ✅ TUI Advantages (VIRT SPINNER)

- ✅ **Fast over SSH** (native terminal, no lag)
- ✅ **Keyboard-first** (no mouse needed)
- ✅ **Lightweight** (~50MB RAM)
- ✅ **Scriptable** (automation-ready)
- ✅ **Flow state** (stay in terminal)
- ✅ **Headless-friendly** (servers, minimal installs)
- ✅ **Multi-system** (manage many VMs from one terminal)
...
**Perfect for:**  
⚡ SSH Sessions • 🚀 Automation • 💻 Servers • ⌨️ Keyboard Workflows • 🎨 Modern TUI • 📦 Minimal Systems
...
<tr>
<td><b>Interface</b></td>
<td>✅ Terminal (gum + fzf)</td>
<td>❌ GTK GUI only</td>
<td>❌ GTK GUI only</td>
</tr>
<tr>
<td><b>SSH/Remote</b></td>
<td>✅ Perfect (no X11 needed)</td>
<td>⚠️ Needs X11 forwarding</td>
<td>⚠️ Needs X11 forwarding</td>
</tr>
<tr>
<td><b>Distro Support</b></td>
<td>✅ 30+ distros (universal)</td>
<td>⚠️ Mainly GNOME distros</td>
<td>✅ Most distros</td>
</tr>
<tr>
<td><b>Resource Usage</b></td>
<td>✅ Minimal (~50MB RAM)</td>
<td>❌ Heavy (GTK + libs)</td>
<td>❌ Heavy (GTK + libs)</td>
</tr>
<tr>
<td><b>First-Run Setup</b></td>
<td>✅ Auto-detects everything</td>
<td>⚠️ Limited auto-config</td>
<td>⚠️ Manual config needed</td>
</tr>
<tr>
<td><b>ISO Management</b></td>
<td>✅ TUI browser + ACL fixes</td>
<td>❌ Basic file picker</td>
<td>❌ Basic file picker</td>
</tr>
<tr>
<td><b>Snapshots</b></td>
<td>✅ Full management + auto</td>
<td>⚠️ Limited support</td>
<td>✅ Full support</td>
</tr>
<tr>
<td><b>Keyboard Control</b></td>
<td>✅ 100% keyboard-driven</td>
<td>❌ Mouse required</td>
<td>⚠️ Mostly mouse-driven</td>
</tr>
<tr>
<td><b>Scriptable</b></td>
<td>✅ Fully scriptable</td>
<td>❌ GUI only</td>
<td>⚠️ Limited via virsh</td>
</tr>
<tr>
<td><b>System Monitor</b></td>
<td>✅ Live htop-style view</td>
<td>❌ Not available</td>
<td>⚠️ Basic stats only</td>
</tr>
</table>

**🎯 Professional VM Management | 🐧 Universal Linux Support | 💎 Beautiful Terminal UI**

[Why TUI?](#-why-choose-a-tui-over-a-gui) • [Features](#✨-features-at-a-glance) • [Installation](#installation--quick-start) • [Quick Start](#usage-examples) • [vs GUI Tools](#-how-it-compares)

### 📊 By The Numbers

| 🐧 Distros | 📦 Package Managers | 🎯 OS Variants | ⚡ Features | 🔧 Operations |
|:----------:|:-------------------:|:--------------:|:----------:|:-------------:|
| **30+** | **12+** | **30+** | **50+** | **15+** |
...
### ⚠️ When GUI Tools Might Be Better:
...
## 🎬 TUI vs GUI: Workflow Comparison
...
<tr>
<th width="10%">Step</th>
<th width="45%">🖱️ Gnome-Boxes/virt-manager (GUI)</th>
<th width="45%">⌨️ VIRT SPINNER (TUI)</th>
</tr>
<tr>
<td><b>1</b></td>
...
<tr>
<td><b>3</b></td>
<td>Click "Local install media" → Click "Next"</td>
<td>Type VM name (auto-suggests based on system)</td>
</tr>
<tr>
<td><b>4</b></td>
<td>Click "Browse" → Navigate folders → Click file → Click "Open"</td>
<td>TUI file browser with arrow keys OR type path</td>
</tr>
<tr>
<td><b>5</b></td>
<td>Manually type OS name → Wait for search → Click result</td>
<td>Arrow keys through common variants (30+ choices)</td>
</tr>
<tr>
<td><b>6</b></td>
<td>Click in RAM field → Delete → Type new value → Click in CPU field → Delete → Type</td>
<td>Type RAM (shows system total + suggestions)</td>
</tr>
<tr>
<td><b>7</b></td>
<td>Click in disk field → Delete → Type size</td>
<td>Type CPUs (shows available + warnings)</td>
</tr>
<tr>
<td><b>8</b></td>
<td>Click "Advanced" → Scroll → Find graphics option → Click dropdown</td>
<td>Type disk size (shows available space)</td>
</tr>
<tr>
<td><b>9</b></td>
<td>Click network dropdown → Select option</td>
...
<tr>
<td><b>11</b></td>
<td>Click "Finish" → Hope it works</td>
<td>Optional: Preview exact <code>virt-install</code> command</td>
</tr>
<tr>
<td><b>Result</b></td>
<td>⏱️ <b>3-5 minutes</b> (mouse-heavy, many screens)</td>
<td>⚡ <b>45-90 seconds</b> (keyboard-only, single flow)</td>
</tr>
<tr>
<td><b>Errors</b></td>
<td>❌ Cryptic error dialogs, no debug info</td>
<td>✅ Clear messages + command preview for debugging</td>
</tr>
<tr>
<td><b>Remote?</b></td>
<td>🐌 Laggy over X11 forwarding</td>
<td>⚡ Native terminal, zero lag</td>
</tr>
</table>

### 💡 The Killer Feature: Keyboard-First Design

**GUI Problem:** Mouse → Click → Type → Mouse → Click → Type...  
**TUI Solution:** Type → Arrow → Type → Arrow → Enter → Done.
...
### 🌍 Universal Support
- ✅ Works on **30+ Linux distributions**
- ✅ 12+ package managers supported
- ✅ Auto-detects distro & installs deps
- ✅ Nobara, Omarchy, and all major distros

### 💎 Intelligent Design
- ✅ Auto-detects libvirt paths
- ✅ Smart ISO browser with TUI
...
### 🚀 Power Features
- ✅ 3D graphics acceleration (virtio-gl)
- ✅ Snapshot management system
- ✅ Live system monitor
- ✅ One-line installation

### 🛡️ Safety First
- ✅ ACL-based ISO permissions
...
[![Features](https://img.shields.io/badge/📋-Features-blue?style=flat-square)](#✨-features-at-a-glance)
[![What's New](https://img.shields.io/badge/🆕-What's_New-green?style=flat-square)](#whats-new-in-v10)
[![Installation](https://img.shields.io/badge/⚡-Installation-orange?style=flat-square)](#installation--quick-start)
[![Configuration](https://img.shields.io/badge/⚙️-Configuration-purple?style=flat-square)](#configuration)
[![Troubleshooting](https://img.shields.io/badge/🔧-Troubleshooting-red?style=flat-square)](#troubleshooting)
[![Examples](https://img.shields.io/badge/📖-Examples-yellow?style=flat-square)](#usage-examples)
...
### 🌟 Major Features Added (v0.8 → v1.0)

- **🐧 Universal Distribution Support** - Auto-detects and works on 30+ Linux distributions
- **📁 Intelligent Path Detection** - Automatically finds and configures libvirt storage
- **💿 Smart ISO Management** - TUI file browser with permission handling
- **🎨 Beautiful First-Run Experience** - Professional setup wizard with ASCII art
- **🔒 Permission Management** - Automatic ACL-based permission fixing for ISOs
- **🎮 3D Graphics Acceleration** - virtio-gl support for gaming and CAD workloads
- **💾 Smart Resource Allocation** - Context-aware suggestions based on system resources
- **🛡️ Safety Features** - Over-allocation warnings and ESC cancellation support
...
- **Intelligent package name mapping** (e.g., `libvirt-clients` → `libvirt` on Arch)
...
**Option 1: Fix Permissions with ACL (Recommended)** ⭐
```bash
  ...
  ╚██╗ ██╔╝██║██╔══██╗   ██║       ╚════██║██╔═══╝ ██║██║╚██╗██║██║╚██╗██║██╔══╝  ██╔══██╗
   ╚████╔╝ ██║██║  ██║   ██║       ███████║██║     ██║██║ ╚████║██║ ╚████║███████╗██║  ██║
    ╚═══╝  ╚═╝╚═╝  ╚═╝   ╚═╝       ╚══════╝╚═╝     ╚═╝╚═╝  ╚═══╝╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝
                    ...
                    🚀 Your Advanced VM Management Tool 🚀
...
2. 📋 Checks and installs required packages
3. 📥 Installs gum toolkit
4. 💾 Detects libvirt configuration
5. 💾 Saves settings to `~/.spinner_settings`
...
- **➕ Create New VM**: Enhanced creation wizard with:
...
- **📸 Snapshot Manager**: Complete snapshot management system:
...
- **📊 Live System Monitor**: Full-screen htop-lite view with:
...
**📸 Quick Snapshot** - Fast snapshot from VM menu
...
💡 Recommended: Leave at least 25% RAM for host (max ~24576MB for VM)
...
💡 Recommended: Assign 25-50% of host CPUs (suggested: 8 vCPUs)
...
💡 Tip: Virtual disks are thin-provisioned (only use space as needed)
...
💡 VNC: Universal, works everywhere, good for remote access
...
### 🎯 Replace Your GUI VM Tools Today!
...
╭──────────────────────────────────────────────────────────╮
│ virt-install --connect qemu:///system --name test-vm    │
│ --memory 8192 --vcpu 4 --os-variant debian12            │
│ --disk size=100,cache=writeback,bus=virtio              │
│ --cdrom "/path/to/iso" --boot cdrom,hd,menu=on          │
│ --graphics spice,gl=on,listen=none --video virtio       │
...
- 💿 **Smart ISO management** (TUI browser + permission handling)
- 🎨 **Professional first-run wizard** with ASCII art
- 💾 **Context-aware input headers** with system resource info
- 🔒 **ACL-based permission management** for ISOs
- 🎮 **3D graphics acceleration** (virtio-gl support)
- 🛡️ **Safety features** (over-allocation warnings, ESC cancellation)
- 🔧 **Boot order fix** (prevents "no bootable device" errors)
- 🐛 **Bug fixes** (startup crashes, input hangs, file browser issues)

### v0.9 (2025-11-29) - ISO & Permissions
- 💿 ISO permission detection and automated fixing
- 📂 TUI file browser for ISO selection
- 🔗 Symlink and ACL options for ISO access
- 🛠️ Pre-creation ISO validation

### v0.8 (2025-11-29) - Multi-Distro Foundation
- 🐧 Multi-distribution package management
- 📦 Automatic distro detection
- 🗺️ Package name mapping per distro
- 💾 Libvirt directory auto-detection

### v0.7 (Previous)
- 📸 Complete snapshot system
- 📊 Live system monitor
- ⚙️ Settings persistence
- 🔧 Enhanced diagnostics with orphan detection
...
- ✅ Intelligent resource allocation with warnings
- ✅ ESC cancellation throughout entire workflow
...
**Enjoy hassle-free VM management!** 🚀
